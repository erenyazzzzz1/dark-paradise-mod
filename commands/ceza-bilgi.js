...
class İnfo extends Command {
    ...
    async run(message, args, perm) {
        if(!message.member.roles.cache.has("833800714852630538") && !message.member.hasPermission("VIEW_AUDIT_LOG")) return
        ...
        let mute = "833800740799643659"
        let vmute = "833991567487401994"
        let cezalı = "833800739775578112"
